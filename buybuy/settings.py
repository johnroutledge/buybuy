...
# SECRET_KEY = 'django-insecure-n8doj4bf6+5p-ow&c9(s(7s!0jg#0+@jky280n0cmdc2qexg9e'
...
ALLOWED_HOSTS = ['jr-buybuy.herokuapp.com', 'localhost']
...
DEFAULT_FROM_EMAIL = 'john_routledge@hotmail.com'